    ...
    hbox:
        ...
        vbox:
            ...
            vbox:
                ...
                if not main_menu:
                    text tra(_("Difficulty: ")) + tra(DIFFICULTY.NAMES[CurrentDifficulty]) color CurrentDifficultyDescColor[CurrentDifficulty]
                    text "{i}" + tra(CurrentDifficultyDesc[CurrentDifficulty]) + "{/i}" size 20
                    bar:
                        style "pref_slider"
                        value VariableValue("CurrentDifficulty", step = 1, min = 0, max = 1)
                    null height 5
        ...
        vbox:
            ...
            vbox:
                style "pref_vbox"
                label _("Other") style "pref_cat_header"
                null height 10
